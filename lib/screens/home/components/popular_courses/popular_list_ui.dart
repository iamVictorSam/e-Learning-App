...
import 'package:nimihub/Models/popular_course.dart';
...
class PopularListUi extends StatelessWidget {
  ...
  const PopularListUi({Key key, this.popularCourse}) : super(key: key);
  @override
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
                          ...
                          Expanded(
                            child: Container(
                              child: Column(
                                ...
                                children: [
                                  CatTitle(popularCourse: popularCourse),
                                  CatLessonsAndRating(
          ...
          CatImage(popularCourse: popularCourse)
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(
            '${popularCourse.lessonsCount} Lessons',
            style: TextStyle(
              letterSpacing: 0.27,
